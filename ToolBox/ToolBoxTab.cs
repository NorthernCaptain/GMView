    ...
    public class ToolBoxTab : ToolBoxItem
    {
      ...
      [Category("ToolBoxTab")]
        ...
        public void HandleKeyDown(KeyEventArgs e)
        {
            ...
            {
                HandleListViewKeyDown(e);
            }
            else
            {
                HandleIconViewKeyDown(e);
            }
        }
        ...
        private void HandleListViewKeyDown(KeyEventArgs e)
        {
            int  oldIndex = -1;
            int  newIndex = -1;
            bool doHandle = true;
        ...
        private void HandleIconViewKeyDown(KeyEventArgs e)
        {
            int  oldIndex  = -1;
            int  newIndex  = -1;
            int  tempIndex = -1;
            ...
            try
            {
                if(Keys.PageUp == e.KeyCode || Keys.PageDown == e.KeyCode)
                {
                    mulFactor = 10;
                }
